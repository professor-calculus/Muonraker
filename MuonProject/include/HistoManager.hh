...
typedef struct {double S1,S2,S3,S4,S5; int evt;} SCINT;
typedef struct {double x,y; int plane,event,track;} TRACK;
...
class HistoManager
{
  public:
   ...
   ~HistoManager();
	...
	void FillScintillatorData(G4double E[5], G4int event);
	void FillTrackHit(G4double, G4double, G4int, G4int, G4int);
