...
void PROJECTPHYSICSLIST::ConstructEM()
{
    ...
    while( (*theParticleIterator)() ){
    	...
    	if (particleName == "gamma") {
      		...
      		//muons
      		G4MuMultipleScattering* muMultiScatter     = new G4MuMultipleScattering();
      		muMultiScatter->SetLateralDisplasmentFlag(displacementFlg);
      		pmanager->AddProcess(muMultiScatter, -1, 1, 1);
